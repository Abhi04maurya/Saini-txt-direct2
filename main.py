...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/iabh4")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/iabhi4"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/iabhi4"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using AẞHI Bot:\n\n"
        ...
        f"**If you have any questions, feel free to ask [AẞHI Bot🚩](https://t.me/iabhi4)! 💬**\n"
        )
    ) 
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [A B H I🚩](https://t.me/iabhi4)"
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [ABHI 🚩](https://t.me/iabhi4)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
